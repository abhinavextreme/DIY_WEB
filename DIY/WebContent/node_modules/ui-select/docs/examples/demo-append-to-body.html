...
<button class="btn btn-default btn-xs" ng-click="ctrl.appendToBodyDemo.startToggleTimer()"
    ...
    {{ ctrl.appendToBodyDemo.remainingTime ? 'Toggling in ' + (ctrl.appendToBodyDemo.remainingTime / 1000) + ' seconds'
    : 'Toggle ui-select presence' }}
</button>
...
<div class="select-box" ng-if="ctrl.appendToBodyDemo.present">
    ...
    <ui-select ng-model="ctrl.country.selected" theme="selectize" ng-disabled="ctrl.disabled" style="width: 300px;"
               title="Choose a country" append-to-body="true">
