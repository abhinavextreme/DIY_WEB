...
<ui-select ng-model="ctrl.person.selected" theme="bootstrap" search-enabled="ctrl.searchEnabled"
           ng-disabled="ctrl.disabled" style="min-width: 300px;" title="Choose a person">
...
<h3>Select2 theme</h3>
<p>Selected: {{ctrl.person.selected}}</p>
<ui-select ng-model="ctrl.person.selected" theme="select2" search-enabled="ctrl.searchEnabled"
...
<ui-select ng-model="ctrl.country.selected" theme="selectize" search-enabled="ctrl.searchEnabled"
