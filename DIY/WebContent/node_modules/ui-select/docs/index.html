...
<div role="main">
    <header class="bs-header text-center" id="overview">
        <div class="container">
            ...
            <p>
                <a class="btn btn-outline-inverse btn-lg" href="https://github.com/angular-ui/ui-select"><i
        ...
        <div class="row">
            <div class="col-md-12">
                <section id="getting_started">
                    ...
                    <ul>
                        <li>
                            <a href="http://angularjs.org" target="_blank">AngularJS</a> (requires AngularJS 1.2.x or
                            higher, tested with 1.5.3).
                        </li>
                        <li>
                            <a href="http://angularjs.org" target="_blank">Angular-Sanitze</a> (the version should match
                            your version of angular.js).
                        </li>
                        <li>
                    ...
                    <p>
                        As soon as you've got all the files downloaded and included in your page you just need to
                        declare
                ...
                <section id="documenation">
                    ...
                    For up to date information please refer to the <a
                        href="https://github.com/angular-ui/ui-select/wiki" target="_blank">Wiki</a>

                    <h3>FAQ</h3>

                    <p>Please check <a href="https://github.com/angular-ui/ui-select/wiki/FAQs" target="_blank">our FAQ
                        section</a> for common problems / solutions.</p>
                </section>
                <section id="examples">
                    <div class="page-header">
                        <h1>Examples</h1>
                    </div>
                    <p>You can fork one of the plunkers from this page to see a working example of what is described
                        here.</p>
...
<footer class="footer">
    <div class="container">
        <p>Designed and built by all ui-select <a href="https://github.com/angular-ui/ui-select/graphs/contributors"
                                                  target="_blank">contributors</a>.</p>

        <p>Code licensed under <a href="https://github.com/angular-ui/ui-select/blob/master/LICENSE">MIT License</a>.
        </p>
