...
(function (S, B) {
    ...
    var ra = $ + "Delay", za = $ + "Duration", ma = T + "Delay", La = T + "Duration", Ma = B.$$minErr("ng"), Ua = {
    ...
    B.module("ngAnimate", []).directive("ngAnimateSwap", ["$animate", "$rootScope", function (a, b) {
        return {
            restrict: "A", transclude: "element", terminal: !0, priority: 600, link: function (b, d, e, l, m) {
                var I, k;
                ...
                "$rootElement", "$document", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", function (b, c, k, l, w, Wa, Q, u, F, n) {
                    ...
                    function t(a,
                        ...
                        if (F) {
                            ...
                            if (d("cancel", a, y, x))if (2 === x.state)x.runner.end(); else if (x.structural)x.close(); else return W(a, x, y), x.runner; else if (d("join", a, y, x))if (2 === x.state)W(a, y, {}); else return Sa(a, k ? h : null, p), h = y.event = x.event, p = W(a, x, y), x.runner
                        } else W(a,
                            y, {});
                    ...
                    var A = new w, L = new w,
                        ...
                        }), h = {}, H = a.classNameFilter(), Xa = H ? function (a) {
                            return H.test(a)
                        } : function () {
                            return !0
                        }, D = V(F), y = S.Node.prototype.contains || function (a) {
        ...
        ["$animateProvider", function (a) {
            ...
            this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$HashMap", "$$rAFScheduler", function (a, d, e, l, m, I) {
                ...
                return function (m, Q, u) {
                        ...
                        s(a, function (a, d) {
                            ...
                            if (h.length) {
                                ...
                                s(h, function (a) {
                                    ...
                                    c[b] = c[b] || {};
                                    c[b][g] = {animationID: d, element: E(a)}
                                })
                            } else b.push(a)
                        });
                        var d = {}, e = {};
                                ...
                                if (!e[m]) {
                                    var k = e[m] = {
                                        structural: !0, beforeStart: function () {
                                            ...
                                            A.close();
                                            t.close()
                                        }, classes: K(A.classes, t.classes), from: A, to: t, anchors: []
                                    };
                    ...
                    v.push({
                        element: m, classes: N, event: Q, structural: ka, options: u, beforeStart: function () {
        ...
        this.$get = ["$window", "$$jqLite",
            "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$$animateQueue", function (a, e, l, m, I, k, v, w) {
                ...
                return function (a, c) {
                    ...
                    if (0 === f.duration || !k.animations && !k.transitions)return G();
        ...
        ["$$animationProvider", function (a) {
            ...
            this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function (a, c, d, e, l, m, I) {
                ...
                function w(c, e, m) {
                    ...
                    function t() {
                        var c = k(m.attr("class") || ""), d = v(c, g), c = v(g, c), d = a(w, {
                            to: l(m),
                    ...
                    var N;
                    c = function () {
                        var c = a(w, {addClass: "ng-anchor-out", delay: !0, from: l(e)});
