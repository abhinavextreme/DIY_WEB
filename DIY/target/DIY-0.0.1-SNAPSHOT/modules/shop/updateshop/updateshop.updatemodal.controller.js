(function (window, document, $, angular) {
    ...
    shopApp.controller("updateModalShopCtrl", ["$scope", "$state", "$rootScope", "$uibModalInstance", "notifySvcs", "shopModel", "shopSvcs", "metadata", function ($scope, $state, $rootScope, $uibModalInstance, notifySvcs, shopModel, shopSvcs, metadata) {
        ...
        mvm.formModel = metadata.data;
        //console.log(mvm.formModel);
        ...
        mvm.formConfig = {
            ...
            submit: function (e) {
                ...
                if (validationResponse.invalidInputs.length == 0) {
                    ...
                    blankFormInstance.className = "EOShop";
                    ...
                    shopSvcs.updateShop(blankFormInstance, function (res) {
