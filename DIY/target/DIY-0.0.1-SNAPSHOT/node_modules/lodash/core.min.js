...
;(function () {
    ...
    function a(n, t, r, e) {
        var u;
        return (u = n === rn) || (u = hn[r], u = (n === u || n !== n && u !== u) && !vn.call(e, r)), u ? t : n
    }
    ...
    function h(n, t, r) {
        for (var e = -1, u = n.length; ++e < u;) {
            var o = n[e], i = t(o);
            if (null != i && (c === rn ? i === i : r(i, c)))var c = i, f = o
        }
        return f
    }
    ...
    function y(n, t, e, u, o) {
        ...
        for (e || (e = z), o || (o = []); ++i < c;) {
            var f = n[i];
            t > 0 && e(f) ? t > 1 ? y(f, t - 1, e, u, o) : r(o, f) : u || (o[o.length] = f)
        }
        return o
    }
    ...
    function d(n, t, r, e, u, o) {
        var i = Tn(n), c = Tn(t), f = "[object Array]", a = "[object Array]";
        i || (f = bn.call(n), f = "[object Arguments]" == f ? "[object Object]" : f),
        c || (a = bn.call(t), a = "[object Arguments]" == a ? "[object Object]" : a);
        var l = "[object Object]" == f && true, c = "[object Object]" == a && true, a = f == a;
        o || (o = []);
        var p = kn(o, function (t) {
            return t[0] === n
        });
    ...
    function m(n) {
        return typeof n == "function" ? n : null == n ? nn : (typeof n == "object" ? E : w)(n);
    }
    ...
    function x(n, t) {
        var r = -1, e = H(n) ? Array(n.length) : [];
        return xn(n, function (n, u, o) {
            e[++r] = t(n, u, o)
        }), e
    }
    ...
    function E(n) {
        ...
        return function (t) {
            ...
            for (t = Object(t); e--;) {
                var u = r[e];
                if (!(u in t && j(n[u], t[u], rn, 3)))return false
            }
            return true
        }
    }
    ...
    function k(n, t, r) {
        var e = -1, u = n.length;
        for (0 > t && (t = -t > u ? 0 : u + t), r = r > u ? u : r,
             0 > r && (r += u), u = t > r ? 0 : r - t >>> 0, t >>>= 0, r = Array(u); ++e < u;)r[e] = n[e + t];
        return r
    }
    ...
    function T(n, t, r, e) {
        ...
        for (var u = -1, o = t.length; ++u < o;) {
            ...
            vn.call(f, i) && (a === c || a !== a && c !== c) && (c !== rn || i in f) || (f[i] = c)
        }
        return r
    }
    ...
    function B(n) {
        return U(function (t, r) {
            var e = -1, u = r.length, o = u > 1 ? r[u - 1] : rn, o = n.length > 3 && typeof o == "function" ? (u--,
                o) : rn;
            for (t = Object(t); ++e < u;) {
                var i = r[e];
                i && n(t, i, e, o)
    ...
    function R(n) {
        return function () {
            var t = arguments, r = l(n.prototype), t = n.apply(r, t);
            return L(t) ? t : r
        }
    }
    ...
    function D(n, t, r) {
        function e() {
            for (var o = -1, i = arguments.length, c = -1, f = r.length, a = Array(f + i), l = this && this !== pn && this instanceof e ? u : n; ++c < f;)a[c] = r[c];
    ...
    function I(n, t, r, e, u, o) {
        ...
        for (var c = -1, f = true, a = 1 & u ? [] : rn; ++c < i;) {
            var l = n[c], p = t[c];
            if (void 0 !== rn) {
                f = false;
                break
    ...
    function $(n, r, e, u, o, i) {
        var c = 2 & o, f = t(n), a = f.length, l = t(r).length;
        if (a != l && !c)return false;
        for (var p = a; p--;) {
            var s = f[p];
            if (!(c ? s in r : vn.call(r, s)))return false
        }
        for (l = true; ++p < a;) {
            var s = f[p], h = n[s], v = r[s];
            if (void 0 !== rn || h !== v && !e(h, v, u, o, i)) {
                l = false;
                break
            }
            c || (c = "constructor" == s)
    ...
    function G(n, t, r) {
        var e = n ? n.length : 0;
        r = typeof r == "number" ? 0 > r ? On(e + r, 0) : r : 0, r = (r || 0) - 1;
        for (var u = t === t; ++r < e;) {
            var o = n[r];
    ...
    function U(n) {
        ...
        return t = On(t === rn ? n.length - 1 : Bn(t), 0), function () {
            for (var r = arguments, e = -1, u = On(r.length - t, 0), o = Array(u); ++e < u;)o[e] = r[t + e];
    ...
    function H(n) {
        var t;
        return (t = null != n) && (t = An(n), t = typeof t == "number" && t > -1 && 0 == t % 1 && 9007199254740991 >= t), t && !K(n)
    }
    ...
    function tn(n, e, u) {
        var o = t(e), i = g(e, o);
        null != u || L(e) && (i.length || !o.length) || (u = e, e = n, n = this, i = g(e, t(e)));
        var c = !(L(u) && "chain" in u && !u.chain), f = K(n);
        return xn(i, function (t) {
            var u = e[t];
            n[t] = u, f && (n.prototype[t] = function () {
    ...
    var rn, en = 1 / 0, un = /[&<>"'`]/g, on = RegExp(un.source), cn = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
        '"': "&quot;",
    ...
    f.prototype = l(c.prototype), f.prototype.constructor = f;
    var xn = function (n, t) {
        return function (r, e) {
            if (null == r)return r;
            if (!H(r))return n(r, e);
    ...
    }(), An = w("length"), wn = String, kn = function (n) {
        return function (r, e, u) {
            var o = Object(r);
            if (e = m(e), !H(r))var i = t(r);
            return u = n(i || r, function (n, t) {
        ...
        var e = n ? n.length : 0;
        if (!e)return -1;
        r = null == r ? 0 : Bn(r), 0 > r && (r = On(e + r, 0));
        n:{
            for (t = m(t), e = n.length, r += -1; ++r < e;)if (t(n[r], r, n)) {
                n = r;
                break n
            }
            n = -1
        ...
        return p(n, Rn(t) || 0, r)
    }), Tn = Array.isArray, Bn = Number, Rn = Number, Dn = B(function (n, r) {
        T(r, t(r), n)
    }), In = B(function (t, r) {
        T(r, n(r), t)
    ...
    c.assignIn = In, c.before = P, c.bind = Nn, c.chain = function (n) {
        ...
        for (var n = arguments.length, t = Array(n ? n - 1 : 0), e = arguments[0], u = n; u--;)t[u - 1] = arguments[u];
        ...
        var e = n ? n.length : 0;
        return r = r === rn ? e : +r, e ? k(n, null == t ? 0 : +t, r) : []
    }, c.sortBy = function (n, t) {
        var r = 0;
        return t = m(t), x(x(n, function (n, e, u) {
            ...
            n:{
                ...
                var e = t.criteria;
                if (r !== e) {
                    var u = r !== rn, o = null === r, i = r === r, c = e !== rn, f = null === e, a = e === e;
    ...
    }, c.values = Z, c.extend = In,
        tn(c, c), c.clone = function (n) {
    ...
    }, c.reduce = M, c.result = function (n, t, r) {
        ...
        var t = (/^(?:replace|split)$/.test(n) ? String.prototype : sn)[n], r = /^(?:push|sort|unshift)$/.test(n) ? "tap" : "thru", e = /^(?:pop|join|replace|shift)$/.test(n);
        c.prototype[n] = function () {
            var n = arguments;
            if (e && !this.__chain__) {
                var u = this.value();
                return t.apply(Tn(u) ? u : [], n)
            }
    ...
    }, (ln || {})._ = c, typeof define == "function" && typeof define.amd == "object" && define.amd ? define(function () {
        return c
