    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <ui-select multiple sortable="true" ng-model="ctrl.person.selected" theme="select2" class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <ui-select ng-model="ctrl.person.selected" theme="select2" class="form-control" ng-disabled="true"
                           title="Choose a person">
                    <ui-select-match placeholder="Select or search a person in the list...">{{$select.selected.name}}
                    </ui-select-match>
                    <ui-select-choices repeat="item in ctrl.people | filter: $select.search">
